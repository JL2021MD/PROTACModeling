...
&cntrl
 ...
 restraintmask=":1-255 & !@H=", ! atoms to be restrained (all in residue 1-253 but not H)
...
strip :WAT:Na+:Cl-
autoimage
reference crystcomplex.gas.pdb parm [2]
...
parm crystcomplex.gas.pdb [2]
trajin 2-10.BDalign.nc parm [1]
reference crystcomplex.gas.pdb parm [2]

rmsd VHL reference ":114-254@CA" out RMSDresults.csv nofit
rmsd BRD4 reference ":1-113@CA" out RMSDresults.csv nofit
rmsd BRD4sidetoCrystal reference ":255@O60,C58,C49,C52,N44,N41" out RMSDresults.csv nofit
rmsd VHLsidetoCrystal reference ":255@CAV,CCH,CCA,CAU,C,OD1,CBW,CB,NBN" out RMSDresults.csv nofit
