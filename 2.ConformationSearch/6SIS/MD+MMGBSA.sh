...
parm crystcomplex.gas.prmtop [2]
trajin 2-10.BRD4align.nc parm [1]
reference crystcomplex.gas.rst7 parm [2]

rmsd VHL reference ":112-252@CA" out RMSDresults.csv nofit
rmsd BRD4 reference ":1-111@CA" out RMSDresults.csv nofit
rmsd BRD4sidetoCrystal reference ":253@CBX,CAD,CAC,CAB,CCG,CCL,CBU" out RMSDresults.csv nofit
rmsd VHLsidetoCrystal reference ":253@CAA,CAV,CCF,CBC,C,OD1,N,CCQ,CBT" out RMSDresults.csv nofit
rmsd LinkerOldtoCrystal reference ":253@OBO,CAY,CAZ,OBP,CBA,CBB,OBQ" out RMSDresults.csv nofit
rmsd LinkerNewtoCrystal reference ":253@O12,C13,C14,O15,C16,C17" out RMSDresults.csv nofit
EOF
cpptraj -i RMSD.in
